...
SOPCINFO_FILE := C:/Users/damit/Desktop/FPGA_Deo_Nano/DE0-Nano_v.1.2.2_SystemCD/Demonstration/Niosii_FPGA/De0_Nano_Qsys2019.sopcinfo
...
# Design Name 
# setting SOPC_NAME is De0_Nano_Qsys2019
SOPC_NAME := De0_Nano_Qsys2019
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x4011030
SOPC_SYSID_FLAG += --sidp=0x4011030
ELF_PATCH_FLAG  += --sidp 0x4011030

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1575540367
SOPC_SYSID_FLAG += --timestamp=1575540367
ELF_PATCH_FLAG  += --timestamp 1575540367
